...
const sendOTPEmail = async (email, otp) => {
    ...
    const mailOptions = {
        from: '"Barber Shop" <no-reply@barbershop.com>',
        to: email,
        subject: "🔐 OTP Verification Code - Barber Shop",
        html: `<!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>OTP Verification - Barber Shop</title>
            <style>
        ...
        <body>
            <div class="email-container">
                <div class="header">Barber Shop - OTP Verification</div>
                ...
                <div class="footer">
                    &copy; 2025 Barber Shop | <a href="https://barbershop.com">www.barbershop.com</a>
                </div>
            </div>
        </body>
        </html>`,
